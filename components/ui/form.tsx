...
function FormControl({ ...props }: React.ComponentProps<typeof Slot>) {
  ...
  const handleInputChange = React.useCallback((originalOnChange: any) => {
    return (event: any) => {
      if (error) {
        clearErrors(name);
      }
  ...
  const handleFocus = React.useCallback((originalOnFocus: any) => {
    return (event: any) => {
      if (error) {
        clearErrors(name);
      }
  ...
  return (
    <Slot
      ...
      {...props}
      onChange={handleInputChange(props.onChange)}
