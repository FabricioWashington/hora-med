  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed hidden md:flex h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear",
          "z-30",
          "top-16",
          side === "left"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className="text-neutral-700" />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 md:mb-15", className)}
      {...props}
    />
  );
}
